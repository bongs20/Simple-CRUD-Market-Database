...
if (isset($_POST['selected_ids']) && !empty($_POST['selected_ids'])) {
    ...
    fputcsv($output, array('ID Pelanggan', 'Nama Pelanggan', 'Riwayat Pembelian', 'No. Telepon'));

    // Ambil data dari database berdasarkan ID yang dipilih
    $query = mysqli_query($koneksi, "SELECT id_pelanggan, nama_pelanggan, riwayat_pembelian, no_telepon FROM pelanggan WHERE id_pelanggan IN ($ids)");
