...
<body class="bg-light">
    <div class="container mt-5">
        ...
        <h3 class="text-center mb-4">Input Laporan Keuangan</h3>
        ...
        <form action="proses_input.php" method="post"> <!-- Perbarui path ke proses_input.php -->
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id_laporan" name="id_laporan" pattern="L\d{3}" title="Format : LXXX" required>
            </div>
            <div class="mb-3">
