                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM detail_pembelian ORDER BY id_detail_pembelian DESC";
                            $qry = mysqli_query($koneksi, $sql);

                            while ($a = mysqli_fetch_array($qry)) {
                                echo "<tr>";
                                echo "<td><input type='checkbox' name='selected_ids[]' value='{$a['id_detail_pembelian']}'></td>";
                                echo "<td>{$a['id_detail_pembelian']}</td>";
                                echo "<td>{$a['id_pembelian']}</td>";
                                echo "<td>{$a['id_barang']}</td>";
                                echo "<td>{$a['harga_satuan']}</td>";
                                echo "<td>{$a['jumlah']}</td>";
                                echo "<td>
                                        <a href=\"edit.php?id_detail_pembelian={$a['id_detail_pembelian']}\" class=\"btn btn-warning btn-sm\" title=\"Edit\">
                                            <i class=\"fas fa-edit\"></i>
                                        </a>
                                          <a href=\"hapus.php?id_detail_pembelian={$a['id_detail_pembelian']}\" class=\"btn btn-danger btn-sm\" title=\"Hapus\" onclick=\"return confirm('Yakin ingin menghapus data ini?')\"> <!-- Disesuaikan jalur -->
