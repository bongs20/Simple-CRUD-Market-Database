...
$harga_beli = isset($_GET['harga_beli']) ? $_GET['harga_beli'] : '';
$harga_jual = isset($_GET['harga_jual']) ? $_GET['harga_jual'] : '';
$stok = isset($_GET['stok']) ? $_GET['stok'] : '';
$tanggal_kadaluarsa = isset($_GET['tanggal_kadaluarsa']) ? $_GET['tanggal_kadaluarsa'] : '';
?>
<!DOCTYPE html>
<html>
<head>
...
<body class="bg-light">
    <div class="container mt-5">
        ...
        <h3 class="text-center mb-4">Input Data Barang</h3>
