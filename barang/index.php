                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            while ($a = mysqli_fetch_array($qry)) {
                                echo "<tr>";
                                echo "<td><input type='checkbox' name='selected_ids[]' value='{$a['id_barang']}'></td>";
                                echo "<td>{$a['id_barang']}</td>";
                                echo "<td>{$a['nama_barang']}</td>";
                                echo "<td>{$a['kategori']}</td>";
                                echo "<td>{$a['harga_beli']}</td>";
                                echo "<td>{$a['harga_jual']}</td>";
                                echo "<td>{$a['stok']}</td>";
                                echo "<td>{$a['tanggal_kadaluarsa']}</td>";
                                echo "<td>
                                        <a href=\"edit.php?id_barang={$a['id_barang']}\" class=\"btn btn-warning btn-sm\" title=\"Edit\"> <!-- Disesuaikan jalur -->
                                            <i class=\"fas fa-edit\"></i>
                                        </a>
                                          <a href=\"hapus.php?id_barang={$a['id_barang']}\" class=\"btn btn-danger btn-sm\" title=\"Hapus\" onclick=\"return confirm('Yakin ingin menghapus data ini?')\"> <!-- Disesuaikan jalur -->
