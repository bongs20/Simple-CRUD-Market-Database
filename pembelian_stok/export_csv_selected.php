...
if (isset($_POST['selected_ids']) && !empty($_POST['selected_ids'])) {
    ...
    fputcsv($output, array('ID Pembelian', 'ID Pemasok', 'Tanggal Pembelian', 'Total Biaya'));

    // Ambil data dari database berdasarkan ID yang dipilih
    $query = mysqli_query($koneksi, "SELECT id_pembelian, id_pemasok, tanggal_pembelian, total_biaya FROM pembelian_stok WHERE id_pembelian IN ($ids)");
