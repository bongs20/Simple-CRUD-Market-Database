...
<body class="bg-light">
    ...
    <ul class="dropdown-menu">
        ...
        <li><a class="dropdown-item" href="../pembelian_stok/index.php">Detail Transaksi</a></li>
        <li><a class="dropdown-item" href="../pembelian_stok/index.php">Supplier</a></li>
        ...
        <li><a class="dropdown-item" href="../pembelian_stok/index.php">Pembelian Stok</a></li>
            ...
            <h1 class="text-center mb-4">Pembelian Stok</h1>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM pembelian_stok ORDER BY id_pembelian DESC";
                            $qry = mysqli_query($koneksi, $sql);

                            while ($a = mysqli_fetch_array($qry)) {
                                echo "<tr>";
                                echo "<td><input type='checkbox' name='selected_ids[]' value='{$a['id_pembelian']}'></td>";
                                echo "<td>{$a['id_pembelian']}</td>";
                                echo "<td>{$a['id_pemasok']}</td>";
                                echo "<td>{$a['tanggal_pembelian']}</td>";
                                echo "<td>{$a['total_biaya']}</td>";
                                echo "<td>
                                        <a href=\"edit.php?id_pembelian={$a['id_pembelian']}\" class=\"btn btn-warning btn-sm\" title=\"Edit\">
                                            <i class=\"fas fa-edit\"></i>
                                        </a>
                                            <a href=\"hapus.php?id_pembelian={$a['id_pembelian']}\" class=\"btn btn-danger btn-sm\" title=\"Hapus\" onclick=\"return confirm('Yakin ingin menghapus data ini?')\"> <!-- Disesuaikan jalur -->
