...
if (isset($_POST['selected_ids']) && !empty($_POST['selected_ids'])) {
    ...
    fputcsv($output, array('ID Detail Transaksi', 'ID Transaksi', 'ID Barang', 'Jumlah', 'Subtotal'));

    // Ambil data dari database berdasarkan ID yang dipilih
    $query = mysqli_query($koneksi, "SELECT id_trx, id_transaksi, id_barang, jumlah, sub_total FROM detail_transaksi WHERE id_trx IN ($ids)");
