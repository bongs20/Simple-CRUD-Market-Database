        ...
        <div class="container mt-5">
            ...
            <form action="hapus_terpilih.php" method="post">
                ...
                <div class="d-flex justify-content-end mt-3">
                    <button type="submit" class="btn btn-danger me-2">Hapus Terpilih</button>
                    <button formaction="export_csv_selected.php" formmethod="post" class="btn btn-info me-2">Download CSV</button>
                    <a href="input.php" class="btn btn-success me-2">Tambah Data</a>
