        ...
        <div class="container mt-5">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="../detail_transaksi/index.php">Detail Transaksi</a></li>
            ...
            <form action="hapus_terpilih.php" method="post"> <!-- Disesuaikan jalur -->
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            while ($a = mysqli_fetch_array($qry)) {
                                echo "<tr>";
                                echo "<td><input type='checkbox' name='selected_ids[]' value='{$a['id_transaksi']}'></td>";
                                echo "<td>{$a['id_transaksi']}</td>";
                                echo "<td>{$a['id_pelanggan']}</td>";
                                echo "<td>{$a['tanggal_transaksi']}</td>";
                                echo "<td>{$a['total_harga']}</td>";
                                echo "<td>{$a['metode_pembayaran']}</td>";
                                echo "<td>
                                        <a href=\"edit.php?id_transaksi={$a['id_transaksi']}\" class=\"btn btn-warning btn-sm\" title=\"Edit\"> <!-- Disesuaikan jalur -->
                                            <i class=\"fas fa-edit\"></i>
                                        </a>
                                            <a href=\"hapus.php?id_transaksi={$a['id_transaksi']}\" class=\"btn btn-danger btn-sm\" title=\"Hapus\" onclick=\"return confirm('Yakin ingin menghapus data ini?')\"> <!-- Disesuaikan jalur -->
                ...
                <div class="d-flex flex-wrap justify-content-end mt-3 gap-2">
                    ...
                    <button formaction="export_csv_selected.php" formmethod="post" class="btn btn-info btn-sm"> <!-- Disesuaikan jalur -->
                        <i class="fas fa-file-download"></i>
                    </button>
                    <a href="input.php" class="btn btn-success btn-sm"> <!-- Disesuaikan jalur -->
                        <i class="fas fa-plus"></i>
                    </a>
                    <a href="../logout.php" class="btn btn-danger btn-sm"> <!-- Disesuaikan jalur -->
