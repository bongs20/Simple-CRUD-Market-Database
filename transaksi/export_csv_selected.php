...
if (isset($_POST['selected_ids']) && !empty($_POST['selected_ids'])) {
    ...
    fputcsv($output, array('ID Transaksi', 'ID Pelanggan', 'Tanggal Transaksi', 'Total Harga', 'Metode Pembayaran'));

    // Ambil data dari database berdasarkan ID yang dipilih
    $query = mysqli_query($koneksi, "SELECT id_transaksi, id_pelanggan, tanggal_transaksi, total_harga, metode_pembayaran FROM transaksi WHERE id_transaksi IN ($ids)");
